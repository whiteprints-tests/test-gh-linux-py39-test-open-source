...
<summary><b>🙏 New contributors, please read!</b></summary>
  ...
  <ul>
    <li>Before submitting the pull request, please ensure the PR follows the <a href="https://github.com/whiteprints-tests/test-gh-linux-py39-test-open-source/blob/main/CONTRIBUTING.md">Contributing Guide</a>.</li>
    ...
    <li>We demand that you follow our <a href="https://github.com/whiteprints-tests/test-gh-linux-py39-test-open-source/blob/main/CODE_OF_CONDUCT.md">Code of Conduct</a>.</li>
  </ul>
</details>
...
<summary><b>🛂 Checklist</b></summary>
    ...
    <ul>
        <li>I agree to follow this project's <a href="https://github.com/whiteprints-tests/test-gh-linux-py39-test-open-source/blob/main/CODE_OF_CONDUCT.md">Code of Conduct</a></li>
        <li>I have read the <a href="https://github.com/whiteprints-tests/test-gh-linux-py39-test-open-source/blob/main/CONTRIBUTING.md">Contributor Guide</a></li>
